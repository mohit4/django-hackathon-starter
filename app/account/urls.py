...
from .views import UserRegisterView, UserLoginView, ProfileDetailView, ProfileUpdateView, ProfileListView
...
urlpatterns = [
    ...
    path('account/all/', ProfileListView.as_view(), name='profile-list'),
